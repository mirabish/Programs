         ...
         if(line.contains("GET")){
            ...
            for(int i = 0; i < cstr.length; i++){ //iterates through the given array and gets the file address from GETS.
             ...
             addressNew = new String(cstr); //stores given array int
               System.err.println(addressNew);
              tempFile = new File(addressNew); 
...
//need to remove GETS and http 1.1
// toString???
/**
...
private void writeHTTPHeader(OutputStream os, String contentType) throws Exception
{
  ...
  if(exists == true){ 
   ...
   os.write("HTTP/1.1 404 Not Found\n".getBytes()); //turns into a byte homie dont take strings.
...
private void writeContent(OutputStream os) throws Exception
{
   ...
   int coolByte;
   InputStream mystream = new FileInputStream(tempFile);
   while ((coolByte = mystream.read()) != -1) {
      os.write(coolByte);}
}
